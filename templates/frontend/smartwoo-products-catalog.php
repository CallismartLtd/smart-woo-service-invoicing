...
<div class="smartwoo-page">
    ...
    <?php if ( empty( $smartwoo_products ) ) : ?>
        <div class="main-page-card">
            <p><?php esc_html_e( 'No subscripton product found, please contact us if you help.', 'smart-woo-service-invoing' ) ?></p>
        ...
        <div class="sw-products-container">
            <?php foreach( $smartwoo_products as $product ) : $GLOBALS['product'] = $product; ?>
                <div class="sw-product-container">
                	...
                	<p>Price: <?php echo smartwoo_price( $product->get_regular_price() ); ?></p>
                    <p>Sign-Up Fee: <?php echo smartwoo_price( $product->get_sign_up_fee() ); ?></p>
