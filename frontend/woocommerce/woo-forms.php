 ...
 */
function sw_add_user_bio_and_website() {
    ...
    <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
        <label for="bio"><?php esc_html_e('Bio', 'smart-woo-invoice'); ?></label>
    ...
    <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
        <label for="website"><?php esc_html_e('Website', 'smart-woo-invoice'); ?></label>
        <input type="url" class="woocommerce-Input woocommerce-Input--text input-text" name="website" id="website" value="<?php echo esc_attr( $website ); ?>" />
    </p>
    <?php
}
add_action( 'woocommerce_edit_account_form', 'sw_add_user_bio_and_website' );
...
function sw_add_billing_website_to_billing_edit_form() {
    ...
    <p class="form-row form-row-wide">
        <label for="billing_website"><?php esc_html_e('Billing Website', 'smart-woo-invoice'); ?></label>
        <input type="url" class="input-text" name="billing_website" id="billing_website" value="<?php echo esc_attr( $website ); ?>" />
    </p>
    <?php
