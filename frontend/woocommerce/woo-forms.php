 ...
 */
function smartwoo_add_billing_website_to_woo_edit_form() {
...
add_action( 'woocommerce_after_edit_address_form_billing', 'smartwoo_add_billing_website_to_woo_edit_form' );